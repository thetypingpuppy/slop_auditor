...
Even better is heterogenous ensemble learning, that combines different models of different *types*. See Re (2012).

Here we add a non-LLM based system for detecting logical contradiction in natural language, a cross-encoder known as nli-deberta-v3-large.
...
### References
Re, Matteo & Valentini, Giorgio. (2012). Ensemble methods: A review.
